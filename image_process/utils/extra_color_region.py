...
# 提取液体柱上方空气柱的6个值：0, 50, 0, 150, 70, 255。
cv2.createTrackbar('Hmin', winName, 44, 255, nothing)
cv2.createTrackbar('Hmax', winName, 143, 255, nothing)
cv2.createTrackbar('Smin', winName, 0, 255, nothing)
cv2.createTrackbar('Smax', winName, 255, 255, nothing)
cv2.createTrackbar('Vmin', winName, 38, 255, nothing)
