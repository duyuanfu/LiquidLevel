...
from border_detection.nets.yolo4_tiny import YoloBody
from border_detection.utils.utils import (DecodeBox, letterbox_image, non_max_suppression,
                                         yolo_correct_boxes)
...
class YOLO(object):
    _defaults = {
        "model_path": r'E:\Pycharm\Workplace\LiquidLevel\border_detection\logs\weights_20211115_2.pth',
        "anchors_path": r'E:\Pycharm\Workplace\LiquidLevel\border_detection\model_data\yolo_anchors.txt',
        "classes_path": r'E:\Pycharm\Workplace\LiquidLevel\border_detection\model_data\classes.txt',
        # -------------------------------#
        #   所使用的注意力机制的类型
        #   phi = 0为不使用注意力机制
        #   phi = 1为SE
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(top_label):
            ...
            pos_cls_info.append([top, left, bottom, right, c])
            top = top - 5
            left = left - 5
            bottom = bottom + 5
            right = right + 5
