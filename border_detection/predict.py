...
from border_detection.yolo import YOLO
...
if __name__ == "__main__":
    ...
    if mode == "predict":
        ...
        2、如果想要进行检测完的图片的保存，利用r_image.save("example.jpg")即可保存，直接在predict.py里进行修改即可。 
        ...
        while True:
            ...
            try:
                ...
                print(image)
                r_image, pos_cls_info = yolo.detect_image(image)
                print(pos_cls_info)
                r_image.show()
        ...
        test_interval = 100
        img = Image.open('voc1/data/00001.jpg')
