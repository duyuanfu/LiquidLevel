...
for file in os.listdir(img_path):   # 遍历访问图像
    ...
    try:
        ...
        cv.imwrite('image_process/example/gear' + str(count) + '.png', detect_image)
        # 获得液位线y = kx + b ==> -y + kx + b = 0
        detect_image = Image.open('image_process/example/gear' + str(count) + '.png')
