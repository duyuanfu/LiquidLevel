...
from image_detection.utils.utils import (DecodeBox, letterbox_image, non_max_suppression,
                                         yolo_correct_boxes)
...
class YOLO(object):
    _defaults = {
        "model_path": r'E:\Pycharm\Workplace\LiquidLevel\image_detection\logs\Epoch100-20211115.pth',
